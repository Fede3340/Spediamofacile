...
useSeoMeta({
	...
	description: 'Dashboard account SpediamoFacile con priorità, spedizioni, pagamenti e supporto.',
	ogDescription: 'Area account SpediamoFacile con viste di ruolo più chiare, pulite e coerenti con il prototipo.',
